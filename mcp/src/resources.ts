...
const indexedSectionNames: IndexedSectionKey[] = [
  "meta",
  "problem",
  "goals",
  "assumptions",
...
export function listSectionResourceDefinitions(indexResult: PrdIndexResult): Resource[] {
...
export function listEntityResourceDefinitions(indexResult: PrdIndexResult): Resource[] {
...
export function listTraceResourceDefinitions(indexResult: PrdIndexResult): Resource[] {
  if (!indexResult.index) {
    return [];
  }
...
export function buildSummaryPayload(load: PrdLoadResult, indexResult: PrdIndexResult) {
  return {
...
export function buildCompatibilityPayload(load: PrdLoadResult) {
  return {
...
export function buildProjectTrackingPayload(load: PrdLoadResult, indexResult: PrdIndexResult) {
...
export function buildReadinessPayload(load: PrdLoadResult, indexResult: PrdIndexResult) {
...
export function buildSectionPayload(name: string, load: PrdLoadResult, indexResult: PrdIndexResult) {
...
export function buildEntityPayload(id: string, load: PrdLoadResult, indexResult: PrdIndexResult) {
...
export function buildTracePayload(id: string, indexResult: PrdIndexResult) {
  if (!indexResult.index) {
    return null;
  }
...
export function listAvailableSectionNames(): string[] {
  return [...new Set([...topLevelSections, ...indexedSectionNames])].sort((left, right) =>
    left.localeCompare(right)
  );
}

export function resolveSectionValue(document: unknown, name: string): unknown {
