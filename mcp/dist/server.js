...
import { normalizeResponseMode, wrapResponse } from "./response-modes.js";
import { buildCompatibilityPayload, buildEntityPayload, buildProjectTrackingPayload, buildReadinessPayload, buildSectionPayload, buildSummaryPayload, buildTracePayload, listAvailableSectionNames, listEntityResourceDefinitions, listSectionResourceDefinitions, listTraceResourceDefinitions } from "./resources.js";
import { agentPacketPresets, buildAgentPacketResult, getEntityResult, getLinkedEntitiesResult, listBlockersResult, listOpenQuestionsResult, listProposedDecisionsResult, searchPrd } from "./tools.js";
export function createServerServices(config) {
...
export function createServer(config, services = createServerServices(config), resolveServices = async () => services) {
    const loader = {
    ...
    server.registerResource("prd-summary-mode", new ResourceTemplate("prd://summary{?mode}", { list: undefined }), {
        title: "PRD summary",
        description: "Compact summary of the active PRD load and index state.",
        mimeType: "application/json"
    }, async (uri) => {
    ...
    server.registerResource("prd-compatibility-mode", new ResourceTemplate("prd://compatibility{?mode}", { list: undefined }), {
        title: "PRD compatibility",
        description: "Schema compatibility status for the active PRD.",
        mimeType: "application/json"
    }, async (uri) => {
    ...
    server.registerResource("prd-readiness-mode", new ResourceTemplate("prd://readiness{?mode}", { list: undefined }), {
        title: "PRD readiness",
        description: "Derived approval and review readiness status for the active PRD.",
        mimeType: "application/json"
    }, async (uri) => {
    ...
    server.registerResource("prd-project-tracking-mode", new ResourceTemplate("prd://project-tracking{?mode}", { list: undefined }), {
        title: "PRD project tracking",
        description: "Project-tracking section and derived counts for the active PRD.",
        mimeType: "application/json"
    }, async (uri) => {
